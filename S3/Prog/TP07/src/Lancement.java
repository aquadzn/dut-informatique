...
public class Lancement {
	...
	System.out.println(info.selectionnerCours(cours -> cours.getNiveau() == Niveau.L1));
	System.out.println(info.selectionnerCours(cours -> cours.getResponsable().getNom().equals("Simonot")));
    }
}
