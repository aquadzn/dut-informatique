...
public class CompteTest {
    ...
    private Client clientJohn = new Client("John", "140 rue de la N. France");
    private Client clientDoe = new Client("Doe", "1 Rue de la Paix");
    private Compte compteJohn = new Compte(1, clientJohn, 10000, 10000);
    private Compte compteDoe = new Compte(2, clientDoe, 1000, 10000);

    @Test
    public final void testVirer() {
...
/*    // Tests du constructeur
    ...
    public final void testCreationNumeroInvalideNegatif() {
        Assertions.assertThrows(CompteException.class, () -> new Compte(-5, clientJames, 0, 0));
    }

    // on considère que zéro n'est pas un numéro de compte valide
    @Test
    public final void testCreationNumeroInvalideZero() {
        Assertions.assertThrows(CompteException.class, () -> new Compte(0, clientJames, 0, 0));
    }

    @Test
    public final void testCreationDecouvertNegatif() {
        Assertions.assertThrows(CompteException.class, () -> new Compte(1, clientJames, 0, -6));
    }

    @Test
    public final void testCreationSoldeInsuffisant() {
        Assertions.assertThrows(CompteException.class, () -> new Compte(1, clientJames, -20000, 10000));
    }
    ...
    public final void testCreationCasLimite() throws CompteException {
        Compte c = new Compte(1, clientJames, Long.MAX_VALUE, 10000);
    ...
    public final void testCrediter() throws CompteException {
        Compte c = new Compte(1, clientJames, 12000, 10000);
        c.créditer(1000);
...
//	}
    ...
    public final void testDebiter() throws CompteException {
        Compte c = new Compte(1, clientJames, 12000, 10000);
        c.débiter(1000);
        Assertions.assertEquals(11000, c.getSolde());
    }
    ...
    public final void testDebiter2() throws CompteException {
        Compte c = new Compte(1, clientJames, 12000, 10000);
        c.débiter(15000);
        Assertions.assertEquals(-3000, c.getSolde());
    }


    @Test
    public final void testDébiterMontantNégatif() throws CompteException {
        Compte c = new Compte(1, clientJames, 12000, 10000);
        Assertions.assertThrows(CompteException.class, () -> c.débiter(-2));
    }

    @Test
    public final void testDebiterDepassementDecouvert() throws CompteException {
        Compte c = new Compte(1, clientJames, 0, 1000);
        Assertions.assertThrows(CompteException.class, () -> c.débiter(1001));
    }*//*
