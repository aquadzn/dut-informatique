...
Révision : 
	- 01/09/2019 tenant compte du PPN2013 et des nouveaux enseignants
	- 4/09/2020 tenant compte des changements des personnes de l'IUT
------------------------------------------------------------------------- */
/* Essai de BD SQL.*/
...
-- table personnel
insert into personnel (idPers, nom, prenom, fonction) VALUES (1, 'Lamolle', 'Myriam', 'Directrice'),
	(2, 'Tudor','Carmen', 'Responsable d''administration'),
	(3, 'Hassoun', 'Abdallah', 'Responsable CCRI'),
	(4, 'Filoche','Eddy', 'Responsable Hygiène et Sécurité'),
	(30, 'Kamal','Rachida', 'Chargé de mission');

insert into personnel (idPers, nom, prenom, fonction, idDept) VALUES (6, 'Bayoud','Khadija', 'Secrétaire Informatique', 'INFO'),
	...
	(10, 'Ricordeau', 'Anne', 'Cheffe de département DUT', 'INFO'),
	...
	(14, 'Emonides','Mireille', 'Responsable Formation Continue', 'INFO');


-- table enseignant
insert into enseignant (idEns, nom, prenom, iddept) VALUES (5, 'Rety', 'Jean-Hugues','INFO'),
...
insert into enseignant values (22, 'Marcinkowski', 'Jérémy', 'f','INFO'), 
(24, 'Khalfi', 'El Mehdi', 'f','INFO'), 
(27, 'Sirot', 'Frédéric', 'f','INFO') ;
	
insert into enseignant values (25, 'Mockel', 'Mehdi', 'f'), 
(26, 'Mourel', 'Frédéric', 'f'), 
(30, 'Kamal','Rachida', 'f') ;

-- table etudiant
insert into etudiant (idEtud, nom, prenom, classe) VALUES (1, 'Turing','Alan', 'S3'), 
(2, 'Lovelace', 'Ada', 'S3'), (3, 'Baggage', 'Charles', 'S3'),
(6, 'Berry', 'Gérard', 'S3'), (8, 'Berner-Lee', 'Tim', 'S1');
insert into etudiant (idEtud, nom, prenom, classe) VALUES (4, 'Meyer', 'Bertrand', 'S1'), 
(5, 'Wirth', 'Niklaus', 'S1'), (7, 'TALON', 'Achille', 'S1');
...
insert into module VALUES ('M1101', 'Introduction aux systèmes informatiques', 'S1', '3.5', 10, 20, 30, 12),
...
insert into module VALUES ('M1201', 'Mathématiques discrètes', 'S1', '2.5', 10, 18, 17, 8),
...
insert into module VALUES ('M2101', 'Architecture et programmation des mécanismes de base d''un système informatique', 'S2', '1.5', 8, 10, 12, 17),
...
insert into module VALUES ('M2201', 'Graphes et langages', 'S2', '2.5', 11, 16, 18, 8),
...
insert into module VALUES ('M3101', 'Principe des systèmes d''exploitation', 'S3', '2.5', 15, 14, 16, 17),
...
insert into module VALUES ('M3201', 'Probabilités et statistiques', 'S3', '2.5', 15, 16, 14, 8),
...
insert into module VALUES ('M3301', 'Méthodologies de la production d''applications', 'S3', '3.0', 14, 22, 24, 11),
